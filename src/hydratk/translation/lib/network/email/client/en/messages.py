...
msg = {
    'htk_email_unknown_protocol' : "Unknown protocol: '%s'",
    'htk_email_unknown_method'   : "Unknown method for protocol: '%s'",
    'htk_email_connecting'       : "Connecting to server: '%s'",
    'htk_email_connected'        : "Connected successfully",
    'htk_email_disconnected'     : "Disconnected from server",
    'htk_email_sending'          : "Sending email: '%s'",
    'htk_email_sent'             : "Email sent",
    'htk_email_counting'         : "Counting emails",
    'htk_email_count'            : "Email count: '%s'",
    'htk_email_listing'          : "Listing emails",
    'htk_email_listed'           : "Emails listed",
    'htk_email_receiving'        : "Receiving email: '%s'", 
