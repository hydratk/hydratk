...
msg = {    
    'htk_inet_unknown_method' : "Neznámá metoda pro protokol: '%s'",
    'htk_inet_connecting'     : "Připojuji se na server: '%s'",
    ...
    'htk_inet_sending_data'   : "Odesílám data: '%s'",
    'htk_inet_data_sent'      : "Data odeslána",
    'htk_inet_receiving_data' : "Přijímám data do velikosti: '%s'",
    'htk_inet_data_received'  : "Přijata data: '%s'"           
}