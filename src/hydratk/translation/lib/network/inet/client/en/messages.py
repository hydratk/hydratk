...
msg = {
    'htk_inet_unknown_method' : "Unknown method for protocol: '%s'",
    'htk_inet_connecting'     : "Connecting to server: '%s'",
    ...
    'htk_inet_sending_data'   : "Sending data: '%s'",
    'htk_inet_data_sent'      : "Data sent",
    'htk_inet_receiving_data' : "Receiving data up to size: '%s'",
    'htk_inet_data_received'  : "Received data: '%s'"    
}
