...
msg = {
    'htk_jms_connecting'          : "Connecting to JMS server with params: '%s'",
    ...
    'htk_jms_sending_msg'         : "Sending message with params: '%s'",
    'htk_jms_msg_sent'            : "Message sent",
    'htk_jms_sending_error'       : "Error occured during message sending",
    'htk_jms_receiving_msg'       : "Receiving messages with params: '%s'",
    'htk_jms_msg_received'        : "Received '%s' messages",
